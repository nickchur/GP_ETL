...
COMMENT ON FUNCTION s_grnplm_vd_hr_edp_srv_wf.pr_scpl_schemas_parse() IS 'Извлекает payload-записи из tb_scpl_json в tb_scpl_json_schemas для дальнейшей обработки';
