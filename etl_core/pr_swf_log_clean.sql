...
COMMENT ON FUNCTION s_grnplm_vd_hr_edp_srv_wf.pr_swf_log_clean(text, date) IS 'Очищает устаревшие записи из лог-таблиц super-workflow старше указанной даты';
