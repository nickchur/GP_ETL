...
COMMENT ON FUNCTION s_grnplm_vd_hr_edp_srv_wf.pr_log_stat(integer, text, text, text, text) IS 'Собирает статистику таблицы (кол-во строк, даты) и записывает в tb_log_workflow_stat, запускает ztest';
