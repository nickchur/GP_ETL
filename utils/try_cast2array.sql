...
COMMENT ON FUNCTION s_grnplm_vd_hr_edp_srv_wf.try_cast2array(text, boolean) IS 'Безопасное приведение текста к text[], с попыткой нормализации скобок, возвращает NULL при ошибке';
